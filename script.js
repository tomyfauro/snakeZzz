...
const gameOver = () => {
  ...
  toast.style.transform = 'translateY(-420px)'
  setTimeout(() => {
...
const updateScore = () => {
  localStorage.setItem('scoreLeaboarded', score)
  scoreBoard.innerText = score

  const span = document.querySelector('.scoretext span')

  span.innerText = localStorage.getItem('scoreLeaboarded')
}
